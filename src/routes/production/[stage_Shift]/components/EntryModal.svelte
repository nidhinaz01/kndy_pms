<script lang="ts">
  ...
  export let waitingWorkOrders: any[] = [];
    ...
    >
      <div class="p-6">
        <div class="flex items-center justify-between mb-4">
          <h2 id="entry-modal-title" class="text-xl font-semibold theme-text-primary">
            Enter Work Order into {stageCode}
          </h2>
          <button
            type="button"
        ...
        <div class="flex justify-end gap-2">
          ...
          <Button variant="primary" size="sm" on:click={handleConfirm} disabled={isLoading || !selectedWorkOrder}>
