          ...
          <div class="space-y-4">
              ...
              <div class="flex items-center">
                <svg class="w-5 h-5 text-blue-600 mr-2" fill="currentColor" viewBox="0 0 20 20">
                  <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"/>
                                 ...
                                 <span class="text-blue-800 dark:text-blue-200 text-sm">Add additional work requirements with quantity and rate. Amount will be calculated automatically.</span>
              </div>
            </div>
              ...
              <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4 bg-gray-50 dark:bg-gray-800">
                <div class="flex items-center justify-between mb-3">
                  ...
                  {#if formData.additional_requirements.length > 1}
                       ...
                       class="text-red-600 hover:text-red-800 dark:text-red-400 dark:hover:text-red-300 p-1 rounded-full hover:bg-red-100 dark:hover:bg-red-900/20 transition-colors"
                  ...
                  {/if}
                   ...
                   <div>
                     ...
                     <div class="w-full px-3 py-2 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg text-center">
                       <span class="text-lg font-bold text-green-600 dark:text-green-400">₹{row.amount.toFixed(2)}</span>
            ...
            <div class="flex justify-center">
              <button
                ...
                class="inline-flex items-center px-4 py-2 border border-blue-300 rounded-md shadow-sm text-sm font-medium text-blue-700 bg-white hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:bg-blue-900/20 dark:border-blue-700 dark:text-blue-300 dark:hover:bg-blue-900/30 transition-colors"
              >
          ...
          <div class="space-y-4">
            ...
            <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-6">
              <div class="flex items-center">
                ...
                <span class="text-blue-800 dark:text-blue-200 text-sm">Enter the Work Order Cost. GST and Cess will be calculated automatically based on the selected tax rates.</span>
              </div>
            </div>
             ...
             <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
               ...
               <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                 ...
                 <div class="text-center">
                   ...
                   <div id="total_cost_display" class="text-xl font-bold text-green-600 dark:text-green-400">
          ...
          <div class="space-y-6">
            ...
            <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
              <div class="flex items-center">
                ...
                <span class="text-blue-800 dark:text-blue-200 font-medium">Please review all the information below before creating the work order.</span>
              </div>
            </div>
            ...
            <div class="flex items-center space-x-3 p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
              ...
              />
              <label for="confirmation" class="text-sm font-medium text-yellow-800 dark:text-yellow-200">
