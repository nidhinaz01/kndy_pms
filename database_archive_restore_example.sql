...
SELECT id, planning_submission_id, wo_details_id, stage_code, COALESCE(shift_code, 'GEN'), derived_sw_code, other_work_code, worker_id, from_date, from_time, to_date, to_time, planned_hours, std_time_hours, time_worked_till_date, remaining_time, status, notes, report_unplanned_work, sc_required, wsm_id, is_active, is_deleted, created_by, created_dt, modified_by, modified_dt
